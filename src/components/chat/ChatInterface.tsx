    ...
    if (!currentConversation) {
      ...
      setTimeout(() => {
        const greeting = userName 
          ? `Hey ${userName}! Nice to meet you—what can I help you with today?`
          : "Hey there! Nice to meet you—what can I help you with today?";
          ...
          <div className="max-w-2xl mx-auto">
            <div className="relative">
              <Input
                ...
                placeholder="Ask your legal question in everyday language..."
                className="w-full py-3 pr-12 text-gray-800 border-gray-300 rounded-lg focus:border-blue-700 focus:ring-1 focus:ring-blue-700"
              />
